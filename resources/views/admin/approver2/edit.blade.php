...
<div class="max-w-7xl mx-auto p-4 sm:p-6 bg-white border-2 border-blue-400 rounded-lg mt-6 sm:mt-10 shadow-md">
        ...
        <h2 class="text-lg font-semibold bg-blue-50  border-2 border-blue-200 text-blue-900 px-4 py-1 rounded text-center"
>Edit Approver 2</h2>
        ...
        <form method="POST" action="{{ route('admin.approver2.update', $approver->reg_no) }}" class="space-y-6">
            @csrf @method('PUT')
            ...
            <div class="flex justify-between items-center pt-4">
                <a href="{{ route('admin.approver2.index') }}" class="flex items-center text-blue-600 hover:text-blue-800 px-4 py-2 rounded-md transition-colors">
